...
class AndroidLocationObserver(
    ...
    private val client = LocationServices.getFusedLocationProviderClient(context)  //To track user's location

    override fun observeLocation(interval: Long): Flow<LocationWithAltitude> {
        return callbackFlow { // use when dealing with callback and flows
